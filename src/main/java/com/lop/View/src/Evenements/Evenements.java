...
public class Evenements extends JFrame  {
	...
	public Evenements() {
		...
		ImageIcon img_event = new ImageIcon(this.getClass().getResource("/evenement.png"));
		...
		ImageIcon icon_ad_menu = new ImageIcon(this.getClass().getResource("/menu_ajout.png"));
		...
		ImageIcon update_menu_icon = new ImageIcon(this.getClass().getResource("/menu_modif.png"));
		...
		ImageIcon delete_icon_menu = new ImageIcon(this.getClass().getResource("/menu_sup.png"));
		...
		ImageIcon home_icon_menu = new ImageIcon(this.getClass().getResource("/menu_home.png"));
		...
		ImageIcon autres_menu_icon = new ImageIcon(this.getClass().getResource("/menu_autres_.png"));
		...
		home.add(icon_home);
		ImageIcon img_home = new ImageIcon(this.getClass().getResource("/home2.png"));
		...
		ImageIcon img_add_form = new ImageIcon(this.getClass().getResource("/ajout_ev2.png"));
		...
		ImageIcon img_recherche= new ImageIcon(this.getClass().getResource("/recherche.png"));
